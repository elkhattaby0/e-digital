...
const Style = {
    "containre": "w-full flex flex-col items-center justify-center border-b-[0.1px] border-[#E5E5E5] sticky top-0 bg-[#FFFFFF] dark:bg-[#14213D] transition-all duration-300 ease-in-out z-[99]",
