        ...
        <section className={Style.container}>
            <div className={Style.section}>
                ...
                <Slider {...settings} className="w-full h-fit">
                    {data.map((n) => (
                        <div key={n.id} className="px-2 h-full flex justify-center">
                            <div className={Style.card}>
                                <img src={n.img} alt={`edigital - ${n.title}`} className="h-[140px] w-full rounded-xl mb-4 object-cover bg-center" />
...
const Style = {
    ...
    card: "flex flex-col justify-between h-[380px] w-[310px] overflow-hidden cursor-pointer border border-[#14213D] rounded-xl p-4 hover:shadow-md dark:border-[#E5E5E5] transition-all duration-300 ease-in-out group",
