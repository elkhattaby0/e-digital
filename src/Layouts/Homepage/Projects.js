...
const Style = {
    ...
    card: "flex flex-col justify-between h-full min-h-[355px] w-[310px] max-md:min-h-[415px] cursor-pointer border border-[#14213D] rounded-xl p-4 hover:shadow-md dark:border-[#E5E5E5] transition-all duration-300 ease-in-out group",
