        ...
        <section className={Style.container}>
            <div className={Style.section}>
                ...
                <Slider {...settings} className="w-full mt-6">
                    {data.map((n) => (
                        <article key={n.id} className="px-2 h-full">
                            <div className={Style.card}>
                                ...
                                <strong className="font-semibold text-5xl text-[#14213D] my-4 dark:text-[#E5E5E5]">
                                    {n.price}
                                </strong>
...
const Style = {
    ...
    card: "flex flex-col justify-between h-full min-h-[420px] max-md:min-h-[480px] cursor-pointer border border-[#14213D] rounded-xl p-6 hover:shadow-md dark:border-[#E5E5E5] transition-all duration-300 ease-in-out group",
};
