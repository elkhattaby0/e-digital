    ...
    return (
        <section className={Style.container} >
            <div className={Style.section} >
                ...
                <p className={Style.p} >We help you grow your business online with smart design and clean code.</p>
                <a className={Style.a} >
                    Get a Free Quote
...
const Style = {
    ...
    "p": "font-base text-md text-center text-[#000000] leading-[24px] mb-4 dark:text-[#E5E5E5]",
