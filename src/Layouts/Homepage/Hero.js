        ...
        <section className={Style.container} >
            <div className={Style.section} >
                <div className={Style.mobile}>
                    ...
                    >
                        <span className={Style.word}>Smart</span> Web & App Solutions
                    </motion.h1>
                    ...
                    >
                        Build Online. Grow Fast. 
                    </motion.h2>
                    <Paragraph isCenter={true}>
                        We craft modern website and mobile apps to help your business stand out
                    </Paragraph>
...
const Style = {
    ...
    "h1": "text-6xl font-bold text-[#14213D] mb-4 dark:text-[#E5E5E5] max-md:text-center",
    "h2": "text-3xl font-base text-[#14213D] leading-[38px]  mb-4 dark:text-[#E5E5E5] max-md:text-center",
